...
export default function History() {
  return (
 <div className="text-[#7C2D12]/90 flex justify-center items-center  flex-col bg-[#FFEDD5] ">
      <div className="text-start max-w-2xl mt-10">
        <p className=" text-3xl md:ml-0 ml-4  md:text-5xl font-bold">Brief About Myself and My College</p>
        <p className="text-lg md:ml-0 ml-4 text-[#7C2D12]/45 mt-3 leading-relaxed">
      ...
      <div className="text-start w-full max-w-2xl mt-13">
        ...
        <div className="max-w-[800px] mt-4 rounded-xl border-1 h-auto border-[#7C2D12]/20">
          <p className="text-2xl font-semibold  mt-4 ml-5">Diploma in Computer Science</p>
          <p className="text-md text-[#7C2D12]/50 mt-2 ml-5">
          ...
          <p className="text-md text-[#7C2D12]/50 mt-2 ml-5 mb-5">
      ...
      <div className="text-start w-full max-w-2xl mt-13">
        ...
        <div className="max-w-[800px] mt-4 rounded-xl border-1 h-auto border-[#7C2D12]/20">
          ...
          <p className="text-xl text-[#7C2D12]/70 font-light mt-5 mb-5 ml-5">
           - Mern Stack<br/>
           - Next.js<br/>
           - Dev Ops
          </p>
        ...
        <div className="max-w-[800px] mt-4 rounded-xl border-1 h-auto border-[#7C2D12]/20">
          ...
          <p className="text-md text-[#7C2D12]/50 mb-5 mt-2 ml-5">
