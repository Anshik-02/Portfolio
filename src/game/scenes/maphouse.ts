...
export class MapHouse extends Phaser.Scene {
...
this.dpad1 = new DPad(this, 640, 440, 25, this.inputFlags);
   ...
   const map = this.make.tilemap({ key: "maphouse" });
    const tileset = map.addTilesetImage("Trainer Tower interior", "Trainertiles");
