...
export class ResumeHouse extends Phaser.Scene {
...
this.dpad1 = new DPad(this, 640, 440, 25, this.inputFlags);
   ...
   const map = this.make.tilemap({ key: "resumehouse" });
    const tileset = map.addTilesetImage("Department store interior", "resumetiles");
