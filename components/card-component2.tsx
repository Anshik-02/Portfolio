    ...
    <div className='mt-8 md:ml-0 ml-0.5'>
        <div className="grid gap-8 md:grid-cols-2 ">
          {projects.map((project) => (
            <Card key={project.title} className="overflow-hidden border-1 border-[#7C2D12]/20 bg-transparent text-[#7C2D12]">
              <div className="h-48 bg-transparent">
                
                <div className="flex h-full  items-center justify-center  text-muted-[#7C2D12]">
              ...
              <CardFooter className="flex gap-2">
                <a href={project.githubLink}><Button variant="outline" className='text-[#7C2D12] gap-1 hover:!text-[#FFEDD5] hover:brightness-75 cursor-pointer' size="sm" >
